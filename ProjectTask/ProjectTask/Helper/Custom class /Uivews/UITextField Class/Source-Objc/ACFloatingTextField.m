...
-(void)initialization{
    ...
    if (self.rightPadding != 0.0)
    {
        ...
        if (self.imgRight != nil)
        {
            ...
            img.contentMode = UIViewContentModeScaleAspectFit;
            img.frame = CGRectMake(self.rightPadding/4, 0, 16, self.frame.size.height);
...
-(void)addErrorPlaceholderLabel{
    ...
    NSLayoutConstraint *topConstraint = [NSLayoutConstraint constraintWithItem:self.labelErrorPlaceholder attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeBottom multiplier:1.0 constant:0];
